...
import { saveSessions, fetchTodaySessions } from '../services/api'
                    ...
                    <>
                        <div className='grid grid-cols-2 gap-4 mb-12'>
                            <div className='relative rounded-xl border border-gray-700/50 bg-gray-800/30 backdrop-blur-sm p-6 overflow-hidden'>
                                ...
                                <p className='text-white text-4xl font-semibold tracking-tight' style={{ fontFamily: 'JetBrains Mono, monospace' }}>
                                    {getDailyTotal()}
                                </p>
